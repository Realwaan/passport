        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="25%" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
			  ...
			  <tr>
                <td bgcolor="#BDC9BA" onMouseOver="mOvr1(this);" onMouseOut="mOut1(this);" onClick="mClk(this);"><a href="http://www.mbcenter.org/html" class="mainlink" >The Scout Center</a></td>
              </tr>   
            </table>
            <!-- InstanceBeginEditable name="ResourceLinks" --> 
            <p align="center" class="fineprint"><img src="/img/buttons/proudlypinoysmallontrans.png" width="75" height="75" /></p>
            <!-- InstanceEndEditable -->
            <p align="center">
              <iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fmeritbadge&amp;width=220&amp;colorscheme=light&amp;show_faces=true&amp;border_color&amp;stream=true&amp;header=true&amp;height=700" scrolling="No" frameborder="0" style="border:none; overflow:hidden; width:220px; height:700px;" allowtransparency="true"></iframe>
            </p>              
              </td>
              ...
              <p class="maintext">
                <select name="mb" size="1" class="fineprint" id="mb" onchange="javascript:location.href='/htm/meritbadges.php?mb='+this.value;">
                  ...
                  <option value="worldbrotherhood">World Brotherhood*</option>
                </select>
</p>
              <p class="maintext">Depending on your vocational career path, some of the merit badges identified as required may not be required. For more information 
                of what is and what is not required of you, check the <a href="advancement.php">advancement 
                  rank requirements</a>.</p>
              <p class="maintext">There are also merit badges listed on the &quot;13 
                and Above&quot; handbook that doesn't have specific requirements. 
                These merit badges are listed as part of the &quot;<a href="mbinworks.php">In 
                the Works Merit Badge</a>&quot; page.</p>
...
<h1 class="h2">New Senior Scout Passport Program</h1>
<p class="maintext">On May 23, 2019, the <a href="http://www.scouts.org.ph">Boy Scouts of the Philippines</a> issued <a href="/downloads/2019nmemo17.pdf">National Memorandum No. 37</a> with the <a href="/downloads/2019nmemo17-IRR-SS.pdf">Implementing Rules and Regulations of the new Senior Scout Advancement Scheme and Merit Badge System for My Trail Eagle Scout Passport</a>. To shorten it, I call it the &quot;Passport&quot; program. The new requirements are now online on our <a href="/htm/advancement.php">Advancement Rank Page</a>. Note: as per item # 6 on the memo, the revised Senior Scout Advancement Scheme takes effect immediately covering those newly registered Senior Scouts who will start their Scout Advancement for the Year 2019. Currently registered Senior Scouts whose Advancement Rank are in progress shall continue using the old Senior Scout Advancement Scheme.</p>
<h1 class="h2">Revised List of Specialist Ratings</h1>
<p class="maintext">A revised list of <a href="/htm/specialist.php">Specialist Ratings</a> is available based on list released by Yasser F. Sarona for the Boy Scouts of the Philippines. This update is as of January 5, 2016.</p>
<h1 class="h2">Revised Eagle Scout Application Procedure</h1>
<p class="maintext">Download the <a href="/downloads/2012nmemo15.pdf">National Memo No. 51, s 2012</a>. Revised application for <a href="/downloads/APP_EagleScout_2012.pdf">Eagle Scout</a>, <a href="/downloads/APP_MeritBadge_2012.pdf">Merit Badge</a>, and <a href="/downloads/APP_MeritBadgeCounselor_2012.pdf">Merit Badge Counselor</a> are in our <a href="/html/forms.php">Forms Section</a>.</p>
<h1 class="h2">New Downloadable Images</h1>
<p class="maintext">Visit the <a href="http://www.scoutcenter.org/html/pub/downloads.php">Cliparts &amp; Wallpaper Section</a> of Scout Center Dot net and download custom Eagle Scout Youth Patch and Emergency Service Corp.</p>
<p><img src="/img/img_eagleesc.jpg" width="300" height="208" hspace="10" vspace="10" /></p>              
<p>&nbsp;</p>
