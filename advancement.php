              ...
              <tr>
                <td><!-- InstanceBeginEditable name="MainBody" --> 
                  ...
                  <p class="maintext">These are the advancement ranks for both 
                    ...
                    for Senior Scouting. These are now based on the revised Passport Advancement Scheme as of 2019. <a href="/htm/advancement-prepassport.php">Click here for the pre-passport rank requirements</a>.</p>
                  ...
                  <blockquote>
                    ...
                    <p><span class="h2">Senior Scout Program</span><br />
                      <strong><span class="maintext"><a href="/downloads/SS-Eagle-Scout-Passport-FINAL-1.pdf">Download the My Trail to Eagle Scout Advancement Passport</a></span></strong></p>
                    <ul class="maintext">
                      ...
                      <li><a href="ranks.php?rnk=pp-outdoorsman">Outdoorsman Scout</a></li>
                  ...
                  <ol>
                    <li class="maintext">Bronze Anahaw. For any 2 additional <a href="specialist.php">Specialist 
                      Rating</a> after earning the Eagle Scout.</li>
                    <li class="maintext">Silver Anahaw. For any 2 additional <a href="specialist.php">Specialist 
                      Rating</a> after earning the Bronze Anahaw.</li>
                    <li class="maintext">Gold Anahaw. For any 2 additional <a href="specialist.php">Specialist 
                      Rating</a> after earning the Silver Anahaw.</li>
                  </ol>
                  <p class="maintext">&nbsp;</p>
