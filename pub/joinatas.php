            ...
            <p align="center">
              ...
              <tr>
                <td><!-- InstanceBeginEditable name="MainBody" --> 
                  <h1>Association of Top Achiever Scouts</h1>
                  <p class="maintext">The Association of Top Achiever Scouts (ATAS) was formed and launched during the 21st APR Scout Conference in Brunei in December 2004. Its objective is to foster friendship and solidarity amongst those who have achieved the highest Scouting ranks.                  </p>
                  <p class="h2">ATAS Contact</p>
                  <blockquote>
                    <p class="maintext">Webstie: <a href="http://www.atasapr.org/">www.atasapr.org</a></p>
                    <p class="maintext"><strong>Mr. Alexander Wong</strong><br />
                      Membership Director, ATAS<br />
                      9B-1, Elm Tree Towers<br />
                      8-10 Chun Fai Road<br />
                      Jardine's Lookout, Hong Kong<br />
                      Email: <a href="mailto:awong724@netvigator.com">awong724@netvigator.com</a></p>
                  </blockquote>
<p class="h2">ATAS-Related Documents</p>
                  <ul class="maintext">
                    <li><a href="http://www.atasapr.org/pdf/ATASMembershipApplication.pdf">ATAS Application Form</a></li>
                    <li><a href="/pub/pdf/ATAS_01_APRC27S2005.pdf">APR Circular No. 27, Series of 2005 (Announcing ATAS-APR)</a></li>
                  </ul>
                  <p class="maintext">&nbsp; </p>
