            ...
            <p align="center">
              ...
              <tr>
                <td><!-- InstanceBeginEditable name="MainBody" --> 
                  <h1><img src="/img/mbsash.gif" alt="MB Sash" width="75" height="425" align="right" />Wearing Your Merit Badges </h1>
                  <p class="fineprint">From the Advancement and Merit Badge Handbook by the BSP</p>
                  <p class="maintext">The Merit Badge Sash is made of the same material as the pants of your uniform. It is worn over the right shoulder, cutting diagonally across the chest with the other edge touching the left hip bone.</p>
                  <p class="maintext">The sash may be bought from your local Scout Shop. The badges earned are sewn on the sash in two rows one-fourt inche (1/4&quot;) apart from each other. The first two (2) badges should be sewn in a way that when the sash is worn, they are just at the intersection of an imaginary line that runs along the middle of the sash and the one that runs vertically along the middle of your shirt. The succeeding badges are sewn alternately starting above then below the first two (2) badges. The bottom portion of the badges should be perpendicular to the edges of the sash.</p>
                  <p class="maintext">The Merit Badge sash should be worn only during the following occasions:</p>
                  <ol class="maintext">
                    <li>
                      <p>When attending Courts of Honor/Recognition and/or other ceremonical functions.</p>
                    </li>
                    <li>
                      <p>When visiting Jamborees, Youth Forums and other Scouting activities of at least municipal/district level.</p>
                    </li>
                    <li>
                      <p>When appearing before a Board of Review.</p>
                    </li>
                    <li>                      During such occasions as may be prescribed by appropriate authority.                      </li>
                  </ol>
                  <p><span class="maintext">National Office Memorandum Number 78, Series of 2000, prescribes that &quot;Scouts are entitled to wear the badge sash after they earned no less than seven (7) Merit Badges.&quot; The sash also becomes part of the type &quot;A&quot; uniform upon reaching the rank of Outdoorman Scout.</span><br />
                  </p>
                  <span class="maintext"></span><!-- InstanceEndEditable --></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
