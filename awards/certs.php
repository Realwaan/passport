    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="25%" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  <td><a href="/htm/awards/certs.php?tp=list" class="mainlink">List
                    of Awardees</a></td>
                </tr>
                <tr>
                  <td><a href="/htm/awards/certs.php" class="mainlink">Retrieve
                    a Certificate</a></td>
                </tr>
                <tr>
		  ...
		  <p><h2>Retrieve a Certificate</h2>
<form name="form1" method="post" action="/htm/awards/certs.php">
<p class="maintext">Those presented with a Merit Badge Center certificate may retrieve a copy of their certificates on this page. You will need the date your certificate was presented and the control number assigned to your certificate. If you need assistance in retrieving your certificate please <a href="/contactus.php">contact us</a>.</p>
<blockquote><p>
<label><span class="maintext">Certificate Type:
<select name="tp">
<option value="ACCR">Accreditation</option>
<option value="A">Appreciation</option>
<option value="C">Commendation</option>
</select></span></label></p>
<p><span class="maintext"><label>Control Number: <input type="text" name="nm"></label></span></p>
<p><input type="submit" value="Submit"> <input type="reset" value="Clear"><br><span class="fineprint"><a href="/htm/awards/certs.php?tp=list">List of Recipients</a></span></p>
</blockquote></form><p class="fineprint"><strong>NOTE: </strong> The control number is in the format YYYYMMDD_NN. Where YYYYMMDD is the year, month, and day the certificate was issued and NN is the main control number.</p>
          </p>
                <!-- InstanceEndEditable --></td>
              </tr>
            </table></td>
